...
__interrupt void DATA(void)
{
    //Set up the PID Equation
        error = setpoint - temp;            // Calculate error
        integral = integral + error;        // Calculate integral
        derivative = error - previous_error;// Calculate derivative
        if(error > 15)                      // If the temp is 15 degrees Fahrenheit colder then setpoint
        {
            TA0CCR1 = 1000;                 // Turn off the fan
            integral = 0;                   // Set integral to zero
        }

        else if(error < -15)                // If the temp is 15 degrees Fahrenheit warmer then the set point            
        {
        ...
        {
            PWM_Duty = 55 * error + 5 * integral + 0.1 * derivative;    // Our PID equations
        ...
        if(PWM_Duty > 1500)                 // if the pwm is more then 1500
...
#endif
{
  ...
  case  6:                                  // Vector  6:  ADC12IFG0
            ...
            if(bits < 1678)
                temp = 0.019981 * bits + 256.3;

            else if(bits >= 1678 & bits < 2000)
                temp = 0.021 * bits + 254.77;

            else if(bits >= 2000 & bits < 2500)
                temp = 0.023 * bits + 251;

            else if(bits >= 2500 & bits < 2900)
                temp = 0.027 * bits + 241.15;

            else if(bits >= 2900 & bits < 3250)
                temp = 0.035 * bits + 218;

            else if(bits >= 3250 & bits < 3370)
                temp = 0.04 * bits + 202;

            else if(bits >= 3370 & bits < 3540)
                temp = 0.05 * bits + 169;

            else if(bits >= 3540 & bits < 3600)
                temp = 0.07 * bits + 98.5;

            else if(bits >= 3600 & bits < 3700)
                temp = 0.08 * bits + 62;

            else if(bits >= 3700 & bits < 3800)
                temp = 0.1 * bits - 12;

            else if(bits >= 3800 & bits < 3884)
                temp = 0.15 * bits - 202;

            else if(bits >= 3884)
                temp = 0.18 * bits - 318.5;
